...
dpt-board-v1:	export UBOOT_FILE_NAME=uboot_for_dpt_board_v1
dpt-board-v1:	export MAX_UBOOT_SIZE=64
ifndef CONFIG_SKIP_LOWLEVEL_INIT
dpt-board-v1:	export COMPRESSED_UBOOT=1
endif
dpt-board-v1:
	@cd $(BUILD_TOPDIR)/u-boot/ && $(MAKECMD) dpt_board_v1_config
	@cd $(BUILD_TOPDIR)/u-boot/ && $(MAKECMD) ENDIANNESS=-EB V=1 all
	@make --no-print-directory show_size
