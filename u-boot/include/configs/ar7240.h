...
#define CONFIG_MENUPROMPT			"Hit any key to stop autobooting DPT-Board-OS: %2d "
#define CONFIG_AUTOBOOT_PROMPT		"Autobooting DPT-Board-OS in:\t%d s (type 'tpl' to run U-Boot console)\n\n"
