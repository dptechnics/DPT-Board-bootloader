...
void led_toggle(void){
	...
	gpio ^= 1 << GPIO_SYS_LED_BIT;
#elif defined(CONFIG_FOR_DPT_MODULE_V1)
	gpio ^= 1 << GPIO_SYS_LED_BIT;
...
void gpio_config(void){
	...
	/* LED's GPIOs on DPT-Board version 1:
	 *
	 * 27	=> SYS LED (green LED on DPT-Module)
	 *
	 * I/O on development board:
	 * 11	=> Reset switch
	 *
	...
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | 0x1ffff103)); // All GPIO's are output by default
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) & 0xFFFFF7FF)); // GPIO11  (reset) is input

	ar7240_reg_wr (AR7240_GPIO_FUNC, 0x038480ab);
	ar7240_reg_wr (AR7240_GPIO_FUNC_2, 0x101);
